...
class MyApp(QWidget):
    ...
    def instagramStart(self):
        ...
        print(os.getcwd() + "/chromedriver_75")
        global browser
        browser = webdriver.Chrome(
            # "/Users/jihyun/Documents/GitHub/instagram-auto-like-with-Python/chromedriver_74",
            # "/Users" + "User" + self.qle6.text() + "/Downloads/Instagram_auto/chromedriver_74",
            # "C:/github/python-ui-instagram-auto/chromedriver_75.exe",
            # 'C:/github/python-ui-instagram-auto/chromedriver_75/',
            # "/Users/jihyun/Downloads/Instagram_auto/chromedriver_74",
            os.getcwd() + "/chromedriver_75",
